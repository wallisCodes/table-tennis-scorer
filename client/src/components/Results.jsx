...
export default function Results({user, players, matchDetails, heartRateOne, heartRateTwo, smoothHeartRateData, scoreHistory, toAuth, toScores, toDashboard}){
    return (
        <>
            <div className="results-container">
                ...
                {/* Results button */}
                <svg onClick={user ? toDashboard : toAuth} className="next-button" width="48" height="48" clipRule="evenodd" fillRule="evenodd" strokeLinejoin="round" strokeMiterlimit="2" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
